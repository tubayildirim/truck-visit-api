...
internal static class TestData
{
    ...
    public static Driver ValidDriver() => Driver.Create("Ada Lovelace", "A1234567", "+905001234567");
    ...
    /// <summary>Returns a visit already advanced to <paramref name="target"/>.</summary>
